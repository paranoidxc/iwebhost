...
<?php
	foreach( $model->articles as $article ) {
		?>	
		<dl rel_href="<?php echo CController::createurl('article/update', array('id'=> $article->id, 'ajax'=> 'ajax') ) ?>"
			 id="sort_<?php echo $article->id; ?>" rel_id="<?php echo $article->id; ?>" class="thumbnail" >
