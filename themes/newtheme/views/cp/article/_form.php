...
<?php $form=$this->beginWidget('CActiveForm', array(
  ...
  <table class='itable w100S'>
    <thead>
      <tr>
        <td colspan="3" class="pl8P" style="border: none">
    ...
    <!--内容字段 start-->
      <tr>
        <td colspan="2" rowspan="14" class='pl10P'>
      ...
      <tr>
  		  <td class='pl10P'>
          <p><?php echo $form->labelEx($model,'user_id'); ?></p>
  		    <p>
      ...
      <tr>
  		  <td class='pl10P'>
  		    <p><?php echo $form->labelEx($model,'allow_reply'); ?></p>
  		    <p>
      ...
      <tr>
  		  <td class='pl10P'>
          <p><?php echo $form->labelEx($model,'sort_id'); ?></p>
  		    <p>
  	  ...
  	  <tr>
  		  <td class='pl10P'>
          <p><?php echo $form->labelEx($model,'category_id'); ?></p>
  			  <p>
      ...
      <tr>
  		  <td class='pl10P'>
          <p><?php echo $form->labelEx($model,'tpl'); ?></p>
  		    <p><?php echo $form->textField($model,'tpl',
              array('size'=>60,'maxlength'=>255,'class' => 'itext' )); ?></p>
  	  ...
  	  <tr>
  		  <td class='pl10P'>
          <p><?php echo $form->labelEx($model,'pv'); ?></p>
  		    <p><?php echo $form->textField($model,'pv',
              array('size'=>60,'maxlength'=>255,'class' => 'itext' )); ?></p>
  	  ...
  	  <tr>
  		  <td class='pl10P'>
          <p><?php echo $form->labelEx($model,'is_star'); ?></p>
      		<p><?php echo $form->checkbox($model,'is_star'); ?></p>
