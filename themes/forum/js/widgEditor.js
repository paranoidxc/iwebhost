...
var widgStylesheet = "/themes/forum/css/widgContent.css";
...
function widgInit()
{
	...
	if (typeof(document.designMode) == "string" && (document.all || document.designMode == "off"))
	{
        ...
        if( theTextarea.title == "" ){
          theTextarea.title = 'widgEditor';
...
function widgEditor(replacedTextareaID)
{
  ...
  //itodo formatblock
	this.theIframe.contentWindow.document.execCommand('formatblock', false, '<p>');	
	this.theToolbar.setState("SelectBlock", '<p>');		
	return true;
}
